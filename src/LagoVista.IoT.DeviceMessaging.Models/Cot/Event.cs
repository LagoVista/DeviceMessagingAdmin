...
// ContentHash: ec97605546c2afa366f5425a221850bbad9a834bc398bd1ee871b321890e93ba
// IndexVersion: 2
// --- END CODE INDEX META ---
using ProtoBuf;
using System;
...
namespace LagoVista.IoT.DeviceMessaging.Models.Cot
{
	...
	public partial class Event : IExtensible
	{
		...
		{
			Point.Lat = (Detail.Points.Min(pt=> pt.Latitude) + Detail.Points.Max(pt => pt.Latitude)) / 2;
            Point.Lon = (Detail.Points.Min(pt => pt.Longitude) + Detail.Points.Max(pt => pt.Longitude)) / 2;
        }
